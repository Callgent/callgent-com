...
export const metadata: Metadata = {
  title: 'TermsOfService Us - Service as a Callgent',
    ...
    <section className="relative z-10 overflow-hidden pb-16 pt-36 md:pb-20 lg:pb-28 lg:pt-[180px]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-12">
          ...
          <h3 className="mt-8 text-2xl font-bold">7. Service Term</h3>
          <p className="mt-4 text-gray-500">
            The term of our project's service begins when you first use our project and continues until either you or we terminate your use of our project.
          </p>
          <p className="mt-4 text-gray-500">
            We reserve the right to modify, suspend, or discontinue our project at any time and for any reason, without notice or liability to you.
          </p>
          <p className="mt-4 text-gray-500">
            In the event that we terminate your use of our project, we will endeavor to provide you with notice of such termination, but we are under no obligation to do so.
          </p>
          <p className="mt-4 text-gray-500">
            Upon termination of our project's service, your right to use our project will immediately cease. If you wish to terminate your use of our project, you may simply discontinue using it.
          </p>
          <h3 className="mt-8 text-2xl font-bold">8. Changes to Terms</h3>
          <p className="mt-4 text-gray-500">
          ...
          <h3 className="mt-8 text-2xl font-bold">9. Governing Law</h3>
          <p className="mt-4 text-gray-500">
