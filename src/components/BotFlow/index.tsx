                    ...
                    <div className="-mx-4 flex flex-wrap items-center flex-col-reverse lg:flex-row">
                        ...
                        <div className="w-full px-4 lg:w-1/2 flex lg:justify-end">
                            <SectionTitle
                                ...
                                paragraph="Connect the callgent to task owner, through `Server Entries`: Email, SMS, Slack channel, Twitter account, or your own API services...<br/>So that the tasks can be delivered to anywhere to be handled."
                                mb="44px"
                            />
                        </div>
                    </div>
                    ...
                    <div className="-mx-4 flex flex-wrap items-center">
                        <div className="w-full px-4 lg:w-1/2">
                            <SectionTitle
                                ...
                                paragraph="Now the callgent is ready to work, by accepting task requests from anywhere through `Client Entries` in any form: API, Email, Web page, Slack...<br/>The CORE philosophy of Callgent, is to break the silos among Users and systems, with AI empowered `Semantical` and `Progressive` invocation techniques."
                                mb="44px"
                            />
                        </div>
                        <div className="w-full px-1 lg:w-1/2">
